...
const CardDataStats: React.FC<CardDataStatsProps> = ({
  ...
  return (
    <div className="rounded-2xl  bg-white py-6 px-7.5 shadow-default dark:bg-[#090d28]">
      ...
      <div className="mt-4 flex items-end justify-between">
        <div>
          <h4 className="text-title-sm font-light text-black dark:text-bodydark">
            {title1}
          </h4>
        </div>
      ...
      <div className="mt-4 flex items-end justify-between">
        <div>
          <h4 className="text-sm font-light text-black dark:text-bodydark">
            {title2}
          </h4>
        </div>
